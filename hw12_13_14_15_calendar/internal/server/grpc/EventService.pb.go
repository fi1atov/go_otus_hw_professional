...
func (x *Event) GetStop() *timestamp.Timestamp {
	if x != nil {
		return x.Stop
	}
	return nil
...
func (x *EventCreateResult) Reset() {
	*x = EventCreateResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *EventCreateResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EventCreateResult) ProtoMessage() {}

func (x *EventCreateResult) ProtoReflect() protoreflect.Message {
	mi := &file_EventService_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EventCreateResult.ProtoReflect.Descriptor instead.
func (*EventCreateResult) Descriptor() ([]byte, []int) {
	return file_EventService_proto_rawDescGZIP(), []int{1}
}

func (x *EventCreateResult) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_EventService_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x23, 0x0a, 0x11, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x32, 0x3e, 0x0a,
	0x08, 0x43, 0x61, 0x6c, 0x65, 0x6e, 0x64, 0x61, 0x72, 0x12, 0x32, 0x0a, 0x06, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x12, 0x0c, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x1a, 0x18, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x42, 0x0e, 0x5a,
...
var file_EventService_proto_goTypes = []interface{}{
	...
	(*EventCreateResult)(nil),   // 1: event.EventCreateResult
...
var file_EventService_proto_depIdxs = []int32{
	...
	2, // 1: event.Event.stop:type_name -> google.protobuf.Timestamp
	3, // 2: event.Event.notification:type_name -> google.protobuf.Duration
	0, // 3: event.Calendar.Create:input_type -> event.Event
	1, // 4: event.Calendar.Create:output_type -> event.EventCreateResult
...
func file_EventService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_EventService_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventCreateResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
