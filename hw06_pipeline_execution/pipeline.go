...
// конвеер обработки данных test test test
			...
			go func() { // запуск горутины внутри анонимной функции
				...
				for { // В бесконечном цикле:
					...
					case <-done: // Если сигнал завершения получен, горутина завершает работу.
						...
						// получение сигнала Done это повод перестать пересылать данные стейдж, но не повод пересесть читать из канала.
						<-in // Прочитали, отбросили.
						return
